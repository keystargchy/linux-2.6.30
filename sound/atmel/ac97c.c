...
static void snd_at91_ac97_init(struct snd_ac97 *ac97)
{
    atmel_ac97c_write(ac97, 0x18, 0x1f1f);
    atmel_ac97c_write(ac97, 0x76, 0x0010);

    atmel_ac97c_write(ac97, 0x02, 0x0000);
    atmel_ac97c_write(ac97, 0x04, 0x0000);
    atmel_ac97c_write(ac97, 0x0c, 0x0000);
    atmel_ac97c_write(ac97, 0x0E, 0x8000);

    atmel_ac97c_write(ac97, 0x10, 0x0000);
    atmel_ac97c_write(ac97, 0x1c, 0x0000);
}
