...
#define CONFIG_DISABLE_LOGO_CURSOR	/* Disable cursor in boot logo */
...
#if !defined(CONFIG_DISABLE_LOGO_CURSOR)
			       ...
			       int cols, int rows, int new_cols, int new_rows)
{
    ...
    logo_height += (info->var.yres/2) - (logo_height/2);  /* add for align center */
