...
#if defined(CONFIG_AT91_CF) || defined(CONFIG_AT91_CF_MODULE) ||defined(CONFIG_PATA_AT91)
...
static struct sam9_smc_config __initdata at91sam9g20_cf_timing = {
	...
	.mode			= AT91_SMC_READMODE | AT91_SMC_WRITEMODE | AT91_SMC_EXNWMODE_READY | AT91_SMC_BAT_SELECT | AT91_SMC_DBW_8 | AT91_SMC_TDFMODE,
	.tdf_cycles		= 13,
};
...
void __init at91_add_device_cf(struct at91_cf_data *data)
{
	...
	at91_set_A_periph(AT91_PIN_PC10, 1);	/* A25/CFRNW */

	at91_set_A_periph(AT91_PIN_PC15, 1);	/* nWAIT */
	at91_set_B_periph(AT91_PIN_PC6, 1);	/* CFCE1 */
	at91_set_B_periph(AT91_PIN_PC7, 1);	/* CFCE2 */

	if (cs == 4) {
		at91_set_A_periph(AT91_PIN_PC8, 1);	/* NCS4/CFCS0 */

		cf0_data = *data;
		platform_device_register(&at91sam9260_cf0_device);
	} else {
		at91_set_A_periph(AT91_PIN_PC9, 1);	/* NCS5/CFCS1 */
